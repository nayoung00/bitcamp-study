...
public class LessonDaoImpl implements LessonDao {
  ...
  public int insert(Lesson lesson) throws Exception {
    ...
    try (Connection con = dataSource.getConnection();
      ...
      stmt.setString(1, lesson.getStartDate().toString());
      stmt.setString(2, lesson.getEndDate().toString());
  ...
  public List<Lesson> findAll() throws Exception {
    ...
    try (Connection con = dataSource.getConnection();
        PreparedStatement stmt =
            con.prepareStatement("select lesson_id, titl, sdt, edt, tot_hr from lms_lesson")) {
  ...
  public Lesson findByNo(int no) throws Exception {
    ...
    try (Connection con = dataSource.getConnection();
        PreparedStatement stmt =
            con.prepareStatement("select lesson_id, titl, conts, sdt, edt, tot_hr, day_hr"
