...
public class Exam0220 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    if (params.get("title") != null && params.get("content") != null) {
      sqlSession.update("BoardMapper.update3", params);
    } else if (params.get("title") != null) {
      sqlSession.update("BoardMapper.update1", params);
    } else if (params.get("content") != null) {
      sqlSession.update("BoardMapper.update2", params);
    }
