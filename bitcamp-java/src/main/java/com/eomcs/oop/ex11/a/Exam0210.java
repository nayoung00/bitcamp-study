...
public class Exam0210 {
  ...
  class A {
    ...
    // 자바컴파일러는 non-static nested class를 컴파일할 때
    ...
    */
    ...
    void m1() {
      // 인스턴스 멤버(인스턴스블록, 생성자, 인스턴스 메서드, inner class)는
      ...
      // 왜?
      // => innerclass의 객체를 생성할 때 컴파일러가 자동으로 추가한 변수(예: outer)에 
      //    바깥 클래스의 객체 주소가 저장된다.
      ...
      //
      // this.iValue = 100; // 컴파일 오류! (A클래스의 인스턴스를 가리킴)
      // this.im(); // 컴파일 오류!
