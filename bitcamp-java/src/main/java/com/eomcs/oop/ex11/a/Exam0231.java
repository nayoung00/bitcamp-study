...
public class Exam0231 {
  public static void main(final String[] args) {
    ...
    // 주의!!
    // => static nested class와 달리 inner class 객체를 생성할 때 바깥 클래스명으로 생성할 수 없다.
    // 인스턴스를 지정해야 한다.
...
class Exam0231_X {
  class A {
     ...
     * Exam0231_X outer;
     *
     * 우리가 추가한 생성자는 다음과 같이 바깥 클래스의 객체 주소를 받을 수 있도록
     * 파라미터가 추가된다.
     * 
     *   public A(Exam0231_X outer, final String name, final int age) {
     *   this.outer = outer;
     *   this.name = name;
     *   this.age = age;
     *   }
