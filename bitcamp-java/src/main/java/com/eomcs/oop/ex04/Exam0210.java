...
public class Exam0210 {
  public static void main(final String[] args) throws Exception {
    ...
    final String s2 = s1.concat(" ,world!");
    ...
    final String s3 = new String("ABC가각");
    ...
    // => 형식을 갖춘 문자열을 만들기
    final String s4 = String.format("%s님 반갑습니다", "홍길동");
    System.out.println(s4);

    // => 구분자와 문자열들을 파라미터로 받아서 새 문자열을 만든다.
    final String s5 = String.join(":", "홍길동", "임꺽정", "유관순");
    System.out.println(s5);

    // => primitive 값을 문자열로 만든다.
    final String s6 = String.valueOf(true);
    final String s7 = String.valueOf(3.14f);
    final String s8 = String.valueOf(100);
