...
public class Exam0110 {
  ...
  public static void main(String[] args) {
    ...
    // JDBC 드라이버 로딩
    // => java.sql.Drvier 규칙에 따라 정의된 클래스를 로딩한다.
    // => Driver 구현체는 JDBC에 대한 정보를 제공한다.
    // => 또한 DBMS에 연결작업을 수행한다.
    // => Driver 구현체는 DriverManager가 관리한다.
    // => 따라서 접속할 DBMS의 Driver 구현체를 생성하여 DriverManger 에게 등록해야 한다.
    //
    // DriverManager
    // => java.sql.Driver 구현 객체를 관리하는 일을 한다.
    // => DVMS 연결 요청이 들어오면 해당 DBMS의 Driver 구현체를 찾아 작업을 위임한다.
    //
    //
