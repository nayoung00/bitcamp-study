...
public class Exam01_4 {
  public static void main(String[] args) {
    ...
    // 연산 결과가 유효자릿수가 아니라면 값은 깨진다.
    // float 과 float 의 연산 결과는 float 이기 때문이다.
    ...
    // 이유? IEEE 754 이진수 변환 문제이다. 고민하지 마라! 점심먹으러 가자.!! 으아!!!! 점심!! 배고프다!!!!!!!
    // 어떻게 처리할건데? 맨 뒤에 붙은 극한의 작은 수는 그냥 잘라 버린다. 
  }
}
