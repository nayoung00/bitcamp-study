...
public class Exam0411 {
  public static void main(String[] args) {
    ...
    //       00000000000 00000000 00000000 000011 = 3
    //     0|000000000 00000000 00000000 0000011x = 비트 이동
    //       000000000 00000000 00000000 00001100 = 6
    ...
    // => 공식: 
    //    n << s 
    //    - n 이 int 타입이라면, 다음 계산을 통해 s의 최종 값을 결정한다. ??5비트만 취한다
    //          s & 0b11111 = 최종 비트 이동 값
    //        따라서 s의 값은 무조건 0 ~ 31 이다.
    //        결국 s의 값은 s % 32 의 결과와 같다.
    //
    //    - n 이 long 타입이라면, 다음 계산을 통해 s의 최종 값을 결정한다. ??6비트만 취한다
    //          s & 0b11111 = 최종 비트 이동 값
