...
public class Exam01_42 {
  public static void main(String[] args) {
    ...
    // => int 와 int 의 연산 결과가 int의 범위를 넘어가면 의도한 결과가 나오지 않을 수 있다.
    ...
    // 진정한 해결책?
    // -int와 int 연산 결과가 int 크기를 넘어갈 것 같으면 형변환하여 계산하라!!
    r2 = (long)x + (long)y;
...
// - 그래서 두 값을 계산했을 때 결과 메모리를 초과할 경우 값이 짤릴 수 있다.
//   주의하라!
...
//    따라서 int 보다 작은 크기의 메모리 값을 다룰 때는 내부적으로 int로 자동 형변환을 수행한 다음에 연산을 수행한다.
//    내부적으로 자동 형변환하는 것을 
