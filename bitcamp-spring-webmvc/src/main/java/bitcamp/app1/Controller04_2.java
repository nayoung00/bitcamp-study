...
public class Controller04_2 {
  ...
  @GetMapping("h1")
  @ResponseBody
  public void handler1(PrintWriter out, ServletRequest request,
      @RequestParam(value = "name") String name1, @RequestParam(name = "name") String name2, // value와
                                                                                             // name은
                                                                                             // 같은
                                                                                             // 일을
                                                                                             // 한다.
  ...
  @GetMapping("h2")
  @ResponseBody
  public void handler2(PrintWriter out, @RequestParam("name1") String name1, // 애노테이션을 붙이면 필수 항목으로
                                                                             // 인지한다.
                                                                             // 따라서 파라미터 값이 없으면 예외가
                                                                             // 발생한다.
